const { useEffect: useEff, useState: useSt, useRef: useRf } = React;

/* =========================================================
   STREAMING HERO TEXT
   ========================================================= */
function StreamText({ text, speed = 48, onDone }) {
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-4 flex items-center justify-between">
        <a href="#top" className="flex items-center gap-3 group" data-hover>
          <span
            className="w-7 h-7 rounded-md flex items-center justify-center font-mono text-[11px] smooth"
            style={{ background: 'var(--accent)', color: 'var(--bg)' }}
          >
            AR
          </span>
          <span className="font-serif text-[15px]">Archit Rathod</span>
          <span className="font-mono text-[10px] hidden md:inline" style={{ color: 'var(--text-muted)' }}>
            / portfolio · 2026
          </span>
        </a>
...
/* =========================================================
   ...
   ========================================================= */
function Hero() {
  const [streamDone, setStreamDone] = useSt(false);
  return (
    <section id="top" className="relative pt-36 pb-28 px-6 md:px-10 max-w-[1400px] mx-auto">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-10 font-mono text-[10px] uppercase tracking-[0.18em]" style={{ color: 'var(--text-muted)' }}>
        <div className="flex items-center gap-4">
          ...
          <span className="hidden md:flex items-center gap-1.5">
            <IconMapPin size={11} /> chicago, il · 41.8781°N
          </span>
        </div>
        <div className="flex items-center gap-4">
      ...
      <div className="grid md:grid-cols-12 gap-10 items-end">
        <div className="md:col-span-8">
          ...
          >
            <StreamText
              text="Architecting cloud-native systems. Debugging algorithmic fairness."
              speed={32}
          ...
          <p
            ...
            style={{
              ...
              transform: streamDone ? 'translateY(0)' : 'translateY(8px)',
              transition: 'all 0.8s var(--ease)',
            }}
          >
            Bridging scalable data engineering with transparent, responsible AI.
            Specializing in <span style={{ color: 'var(--text-primary)' }}>Python</span>,{' '}
          ...
          >
            <a
              href="projects.html"
              className="smooth px-5 py-3 rounded-md font-mono text-[12px] flex items-center gap-2 uppercase tracking-[0.12em]"
              style={{ background: 'var(--accent)', color: 'var(--bg)' }}
              data-hover
            >
            ...
            <a
              href="#contact"
              className="glass smooth px-5 py-3 rounded-md font-mono text-[12px] flex items-center gap-2 uppercase tracking-[0.12em]"
              data-hover
            >
        ...
        {/* Right column: photo + identity card */}
        <div
          className="md:col-span-4 space-y-4"
          style={{
            opacity: streamDone ? 1 : 0,
            transform: streamDone ? 'translateY(0)' : 'translateY(16px)',
        ...
        >
          <div className="glass rounded-2xl overflow-hidden relative noise">
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(to top, rgba(13,13,20,0.85), transparent 40%)',
                }}
              />
          ...
          <div className="glass rounded-xl p-4 space-y-2 font-mono text-[11px]">
            <div className="flex justify-between">
              ...
              <span>ML fairness · distributed systems</span>
            </div>
            <div className="flex justify-between">
              <span style={{ color: 'var(--text-muted)' }}>stack</span>
              <span>py · ts · pytorch · gcp</span>
            </div>
            <div className="flex justify-between">
      ...
      {/* Scroll indicator */}
      <div
        className="mt-20 flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.18em]"
        style={{
          color: 'var(--text-muted)',
          opacity: streamDone ? 1 : 0,
...
function Marquee() {
  const items = [
    'PyTorch', 'Next.js', 'FastAPI', 'PostgreSQL', 'Kubernetes', 'BigQuery',
    'Neo4j', 'Terraform', 'GCP', 'Docker', 'TypeScript', 'OpenStreetMap',
    'Causal Inference', 'Counterfactuals', 'GSoC · 2025',
  ];
  return (
    <div
...
/* =========================================================
   SECTION HEADER
   ========================================================= */
function SectionHeader({ idx, kicker, title, subtitle }) {
  return (
    <div className="mb-14 grid md:grid-cols-12 gap-6 items-end">
      <div className="md:col-span-7">
        ...
        <h2
          ...
          style={{ fontSize: 'clamp(32px, 4vw, 56px)', lineHeight: 1.05, letterSpacing: '-0.02em', textWrap: 'pretty' }}
        >
          {title}
        </h2>
      </div>
      {subtitle && (
        <p className="md:col-span-5 text-[15px] leading-relaxed" style={{ color: 'var(--text-muted)' }}>
          {subtitle}
        </p>
      )}
    </div>
  ...
  return (
    <section id="work" className="relative px-6 md:px-10 max-w-[1400px] mx-auto py-24">
      <SectionHeader
        ...
        title={<>Tools that <em className="font-serif" style={{ fontStyle: 'italic' }}>prove</em> the thesis.</>}
        subtitle="Three projects that sit at the intersection of scalable systems and responsible AI — a VS Code fairness debugger, a real-estate platform serving 1,000+ ZIPs, and a year of published research."
      />

      {/* Featured: FairLint-DL */}
        ...
        <div className="md:col-span-5">
          <div className="sticky top-28">
            ...
            <p className="text-[15px] leading-relaxed mb-5" style={{ color: 'var(--text-muted)' }}>
              A deep-learning-based fairness debugger that ships as a VS Code extension.
              It wraps a custom PyTorch DNN around a two-phase gradient-ascent counterfactual search,
              cutting auditing time by <span style={{ color: 'var(--text-primary)' }}>40%</span> via real-time causal analysis.
            </p>
            <div className="flex flex-wrap gap-1.5 mb-6">
              {['PyTorch', 'VS Code API', 'TypeScript', 'Causal DAGs', 'Gradient Ascent', 'Counterfactuals'].map((t) => (
      ...
      <div className="mt-12 flex justify-center">
        <a
          href="projects.html"
          className="smooth glass px-6 py-4 rounded-md font-mono text-[12px] flex items-center gap-3 uppercase tracking-[0.12em]"
          data-hover
        >
...
function ProjectCard({ kicker, title, body, tags, stats, icon }) {
  return (
    <div className="glass rounded-2xl p-7 smooth relative overflow-hidden" data-hover>
      <div className="flex items-start justify-between mb-5">
        <span className="font-mono text-[10px] uppercase tracking-[0.18em] px-2 py-1 rounded" style={{ background: 'var(--accent-soft)', color: 'var(--accent)' }}>
          {kicker}
        </span>
  ...
  return (
    <section id="experience" className="relative px-6 md:px-10 max-w-[1400px] mx-auto py-24">
      <SectionHeader
        idx="03"
        kicker="experience"
        title={<>Five roles. <em style={{ fontStyle: 'italic' }}>One</em> throughline.</>}
        subtitle="Research labs, open-source foundations, and a simulation company — all asking the same question: how do we build systems that stay accountable at scale?"
      />

      <div className="relative">
        {/* vertical line */}
        <div
          className="absolute left-[11px] md:left-[80px] top-2 bottom-2 w-px"
          style={{ background: 'linear-gradient(to bottom, transparent, var(--border-strong) 10%, var(--border-strong) 90%, transparent)' }}
        />
        {experiences.map((e, i) => (
          <div key={i} className="relative pl-10 md:pl-[130px] pb-14 last:pb-0">
            {/* node */}
            <div
              className="absolute left-0 md:left-[69px] top-1 w-[22px] h-[22px] rounded-full flex items-center justify-center"
              style={{ background: 'var(--bg)', border: '1px solid var(--border-strong)' }}
            >
              <span
                className="w-2 h-2 rounded-full node-dot relative"
                style={{ background: 'var(--accent)' }}
              />
            </div>
            {/* year tick (desktop) */}
            <div
              className="hidden md:block absolute left-0 top-1 font-mono text-[10px] uppercase tracking-[0.14em] w-[56px] text-right"
            ...
            <div className="glass rounded-xl p-6 smooth" data-hover>
              ...
              <div className="flex flex-wrap gap-1.5">
                {e.stack.map((t) => <span key={t} className="tag">{t}</span>)}
              </div>
            </div>
          </div>
        ))}
...
const skillGroups = [
  {
    icon: <IconCode size={16} />, label: 'Languages',
    items: ['Python', 'TypeScript', 'JavaScript', 'C++', 'SQL', 'Rust', 'HTML', 'CSS'],
  },
  {
    icon: <IconLayers size={16} />, label: 'Frameworks',
    items: ['React.js', 'Next.js', 'Node.js', 'FastAPI', 'Flask', 'PyTorch', 'TensorFlow'],
  },
  {
    icon: <IconCloud size={16} />, label: 'Cloud / DevOps',
    items: ['GCP', 'AWS (EC2, Lambda)', 'Docker', 'Kubernetes', 'CI/CD', 'Terraform'],
  },
  {
    icon: <IconDatabase size={16} />, label: 'Databases',
    items: ['PostgreSQL', 'BigQuery', 'MongoDB', 'Neo4j', 'Redis', 'MySQL'],
  },
];
  ...
  return (
    <section id="skills" className="relative px-6 md:px-10 max-w-[1400px] mx-auto py-24">
      <SectionHeader
        ...
        subtitle="Dense, terminal-style listing — because engineering starts with the primitives you can actually reach for at 2am."
      />
      ...
      <div className="mt-10 glass rounded-xl p-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-1.5">
          {['NLP', 'Data Science', 'Algorithmic Fairness', 'Responsible AI'].map((c) => (
...
const research = [
  {
    year: '2024',
    venue: 'ICDSA 2024 · Springer',
    title: 'Ascend.ai',
    desc: 'Technical exploration of facial expression, tone, and pitch analysis with chatbot guidance for interview preparation.',
  },
  {
    year: '2024',
    venue: 'ICSISCET 2023 · Springer',
    title: 'Automated Disaster Image Classification',
    desc: 'Stacked CNN + XGBoost ensemble for earthquake / flood / wildfire / volcano imagery. 95% accuracy, F1 up to 0.96.',
  },
  {
    year: '2023',
    venue: 'NeurIPS 2023 · MASec',
    title: 'Multi-Agent Simulators for Social Networks',
    desc: 'Position paper reviewing multiagent security via agent-based models of social networks, bridging public/private platform gaps.',
  },
];
  ...
  return (
    <section id="research" className="relative px-6 md:px-10 max-w-[1400px] mx-auto py-24">
      <SectionHeader
        ...
        title={<>Written down, peer-reviewed, <em style={{ fontStyle: 'italic' }}>shipped</em>.</>}
        subtitle="Three papers across responsible AI, disaster response, and social-network simulation."
      />
      ...
      <div className="space-y-0">
        {research.map((r, i) => (
          <a
            key={i}
            href="#"
            className="smooth group grid md:grid-cols-12 gap-6 items-baseline py-7 relative"
            style={{ borderTop: '1px solid var(--border)' }}
            data-hover
          >
            <div className="md:col-span-1 font-mono text-[11px]" style={{ color: 'var(--text-muted)' }}>
              {r.year}
            </div>
            <div className="md:col-span-4 font-mono text-[11px] uppercase tracking-[0.14em]" style={{ color: 'var(--accent)' }}>
              {r.venue}
            </div>
            <div className="md:col-span-6">
              <h3 className="font-serif text-2xl tracking-tight mb-2 smooth group-hover:translate-x-1" style={{ transform: 'translateX(0)' }}>
                {r.title}
              </h3>
    ...
    <section id="contact" className="relative px-6 md:px-10 max-w-[1400px] mx-auto py-28">
      <div className="grid md:grid-cols-12 gap-10">
        <div className="md:col-span-7">
          ...
          <h2
            className="font-serif"
            style={{ fontSize: 'clamp(40px, 6vw, 84px)', lineHeight: 1, letterSpacing: '-0.02em', textWrap: 'pretty' }}
          >
          ...
          <p className="mt-6 max-w-[520px] text-[16px] leading-relaxed" style={{ color: 'var(--text-muted)' }}>
            I&apos;m actively interviewing for summer / full-time roles in AI infrastructure, fairness
            tooling, and applied ML. Let&apos;s find a problem worth debugging together.
          </p>

          {/* email copy widget */}
          <button
            onClick={copy}
            className="glass smooth mt-8 rounded-xl flex items-center gap-4 p-5 group w-full max-w-[520px]"
            data-hover
          >
            <IconMail size={20} />
            ...
            <span
              className="font-mono text-[11px] px-3 py-1.5 rounded-md flex items-center gap-1.5 smooth"
              style={{
        ...
        <div className="md:col-span-5 space-y-2">
          ...
          {links.map((l) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="glass smooth rounded-lg flex items-center justify-between p-4 group"
              data-hover
            >
      ...
      {/* Footer */}
      <div
        className="mt-24 pt-6 flex flex-wrap items-center justify-between gap-4 font-mono text-[10px] uppercase tracking-[0.18em]"
...
Object.assign(window, { Nav, Hero, Marquee, Work, Experience, Skills, Research, Contact });
